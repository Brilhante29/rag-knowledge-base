...
Publication result: `benchmarks/publication/retrieval-baseline-v2.json`; its source commit, image ID, dependency-lock digest, fixture digest, and V1 artifact digest are generated by the producer.
